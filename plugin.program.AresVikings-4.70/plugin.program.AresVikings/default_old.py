...
INSTALLMETHODS   = ['Sempre Pergunte', 'Recarregar Perfil', 'Fechar Kodi']
...
def freshStart(install=None, over=False):
	...
	elif install: yes_pressed=DIALOG.yesno(ADDONTITLE, "[COLOR %s]Voce deseja restaurar seu" % COLOR2, "Kodi para as configuracoes padroes antes de atualizar para a nova versao da [COLOR %s]%s[/COLOR]?" % (COLOR1, install), nolabel='[B][COLOR red]Nao, Cancelar[/COLOR][/B]', yeslabel='[B][COLOR green]Continue[/COLOR][/B]')
